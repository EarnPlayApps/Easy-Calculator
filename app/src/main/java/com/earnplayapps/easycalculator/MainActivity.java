...
public class MainActivity extends Activity {
 ...
 private void loadBanner(){if(!ads||banner==null||bannerLoading||isFinishing()||isDestroyed())return;try{bannerLoading=true;banner.setAdSize(getAdaptiveBannerSize());banner.loadAd(new AdRequest.Builder().build());}catch(Exception e){bannerLoading=false;banner.setVisibility(View.GONE);handler.postDelayed(()->loadBanner(),30000);}}
